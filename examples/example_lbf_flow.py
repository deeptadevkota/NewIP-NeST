...
flow1 = LbfFlow(src_node=setup_obj.h1, dst_node=setup_obj.h3,
                   ...
                   dst_addr_type="ipv6", dst_addr=setup_obj.info_dict[setup_obj.h3.name]['ipv6'], pkt_count=1, 
                   min_delay= 1, max_delay= 1, hops= setup_obj.info_dict[setup_obj.h1.name]["hops"][setup_obj.h3.name])

# flow2 = LbfFlow(src_node=setup_obj.h1, dst_node=setup_obj.h2,
#                    src_addr_type="ipv6", src_addr=setup_obj.info_dict[setup_obj.h1.name]['ipv6'],
#                    dst_addr_type="ipv6", dst_addr=setup_obj.info_dict[setup_obj.h2.name]['ipv6'], pkt_count=10)
